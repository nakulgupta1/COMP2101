...
interfaceList=()
if [[ $interface == "all-except-loopback" ]]
then
...
for interface in "${interfaceList[@]}"; do
	...
	# To ensure your network numbers have names, add them to your /etc/networks file, 
	# one network to a line, as   networkname networknumber
